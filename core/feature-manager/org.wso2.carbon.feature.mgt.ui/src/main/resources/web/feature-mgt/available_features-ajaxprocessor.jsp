             ...
             <%
				     ...
				     %>                                                    
                                     ...
                                     <%
                                                	...
                                                	if( (groupByCategory && !popedFeature.isParentComposite() && height > 1) || 
                                                			(groupByCategory && popedFeature.isParentComposite() && height > 2) ||
                                                			(!groupByCategory && !popedFeature.isParentComposite() && height != 0)) { 
                                     %>
                                                <img src="images/spacer.png" style="height:1px;width:10px;"  />

                                     <%
                                                	 } else {
                                                		 		//disable checkbox for mandatory features so users cannot deselect them during installations
                                                  	 			if ((FeatureWrapper.MANDATORY_FEATURE_TYPE).equals(feature.getFeatureType())) {
                                     %>
