...
import org.wso2.carbon.api.UnloadTenantTask;
...
import org.wso2.carbon.context.ContextUtils;
...
public final class CarbonContextDataHolder {
    ...
    private static void setupAuthenticator(CarbonAuthenticator authenticator) throws Exception {
        OMElement documentElement = ContextUtils.toOM(
                ServerConfiguration.getInstance().getDocumentElement());
    ...
    private static class CarbonInitialJNDIContext implements EventDirContext, LdapContext {
        ...
        static {
            ...
            superTenantOnlyUrlContextSchemes = Arrays.asList(
                    ServerConfiguration.getInstance().getProperties(
    ...
    public void setTenantDomain(String domain) {
        try {
            if (this.tenantDomain == null ||
                    this.tenantDomain.equals(MultitenantConstants.SUPER_TENANT_DOMAIN_NAME)) {
