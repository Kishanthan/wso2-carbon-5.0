...
public class CarbonDeploymentUtils {
     ...
     * @param artifact
     */
    public static boolean isArtifactModified(File file, Artifact artifact) {
        long currentTimeStamp = artifact.getLastModifiedTime();

        setArtifactLastModifiedTime(file, artifact);
     ...
     * @param artifact
     */
    public static void setArtifactLastModifiedTime(File file, Artifact artifact) {
        if (artifact.getLastModifiedTime() < file.lastModified()) {
