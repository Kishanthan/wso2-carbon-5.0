...
//public interface ClusteringAgent extends ParameterInclude {
     ...
     *
     * @throws ClusteringException If an error occurs while initializing this node or joining the cluster
     */
     ...
     * requests.
     *
     * @throws ClusteringException If an error occurs while leaving the cluster
     */
