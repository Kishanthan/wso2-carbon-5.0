...
import org.wso2.carbon.clustering.api.GroupManagementCommand;
...
public class HazelcastGroupManagementAgent implements GroupManagementAgent {
    ...
    public void init(Config primaryHazelcastConfig) {
        ...
        groupManagementTopic.addMessageListener(new GroupManagementCommandListener());
    }
    ...
    @Override
    public void send(GroupManagementCommand groupManagementCommand) throws ClusteringException {
    ...
    private static class GroupManagementCommandListener implements MessageListener<GroupManagementCommand> {
        ...
        private GroupManagementCommandListener() {
        }
