...
public final class CarbonContextDataHolder {
    ...
    public static CarbonContextDataHolder getCurrentCarbonContextHolder() {
      ...
      CarbonContextDataHolder currentCarbonContext = getThreadLocalCarbonContextHolder();
      if (null == currentCarbonContext){
         try {
           //2. Check MessageContext
           MessageContext messageContext = MessageContext.getCurrentMessageContext();
           if (messageContext != null) {
               currentCarbonContext =  getCurrentCarbonContextHolder(messageContext);
           } else {
            //3. Check ConfigurationContext
               currentCarbonContext =  getCurrentCarbonContextHolder((ConfigurationContext) null);
           }
